...
/**
 * Le corps de `/dashboard/plantes/nouveau`. La page elle-même est un Server
 * Component : elle résout le `?plant=<slug>` que porte une inscription venue
 * de la page publique `/identifier`, et passe la fiche ici.
 */
    ...
    <div className="flex flex-col gap-8 max-w-2xl">
      ...
      <div className="bg-white rounded-2xl shadow-card p-6 md:p-8">
        <PlantForm
          ...
          submitLabel="Ajouter la plante"
          initialCatalogPlant={initialCatalogPlant}
        />
      </div>
    </div>
  )
