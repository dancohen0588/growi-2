...
import { ChevronLeft, Heart, MessageCircle, UserPlus } from 'lucide-react-native'
  ...
  return (
    <SafeAreaView className="flex-1 bg-sand" edges={['top', 'left', 'right']}>
      <View className="flex-row items-center gap-2 px-4 py-3">
        ...
        <Text className="flex-1 font-poppins-bold text-screen text-forest">Notifications</Text>
      </View>
