...
import { indicatorTone, type DashboardSummary } from '@growi/shared'
 ...
 *
 * Les mêmes indicateurs, dans le même ordre et avec les mêmes couleurs. La
 * grille de raccourcis du web n'est pas reprise : la barre d'onglets remplit
 * déjà ce rôle sur téléphone.
 */
    ...
    <SafeAreaView className="flex-1 bg-sand" edges={['top', 'left', 'right']}>
      ...
      >
        ...
        <Pressable
          ...
          accessibilityRole="button"
          className="flex-row items-center gap-3 rounded-2xl border border-lime bg-lime/20 p-4"
